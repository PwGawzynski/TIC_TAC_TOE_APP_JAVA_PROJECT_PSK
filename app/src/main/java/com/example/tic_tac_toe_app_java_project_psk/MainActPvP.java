...
/**
 * @author Paweł Gawżyński & Barłomiej Grzesik gr. 2ID12B
 */
 ...
 */
public class MainActPvP extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_act_pv_p);
